...
from Gpt.models import Conversation

SYSTEM_PROMPT = 'Ти - особистий ассистент, дружній, спілкуєшся лише українською'
...
def send_message(request):
    ...
    try:
        response = client.chat.completions.create(
            model="gpt-5.5",  # дешева і швидка модель, гарна для старту
            messages=history,
        )
